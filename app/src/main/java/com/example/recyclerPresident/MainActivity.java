...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presidentsList.add(new Presidents("KP Sharma Oli",R.drawable.kpu,"Barack Hussein Obama II is an American attorney and politician who served as the 44th president of the United States from 2009 to 2017."));
        presidentsList.add(new Presidents("Jimmy Carter",R.drawable.jimmy,"Jimmy Carter (James Earl Carter, Jr.), thirty-ninth president of the United States, was born Oct. 1, 1924, in the small farming town of Plains, Georgia, and grew up in the nearby community of Archery. His father, James Earl Carter, Sr., was a farmer and businessman; his mother, Lillian Gordy Carter, a registered nurse. He was educated in the public school of Plains, attended Georgia Southwestern College."));
        presidentsList.add(new Presidents("KP Sharma Oli",R.drawable.kpu,"K.P. Oli was born on 22 February 1952 in a Brahmin family at Terathum. He was the eldest child of Mohan Prasad and Madhumaya Oli. Oli was raised by his grandmother, Rammaya, after his mother died of smallpox when Oli was four.[7] He did his primary school education in Tehrathum and later his family migrated to the south eastern district of Jhapa. He resided mostly in Jhapa during his early political life."));
